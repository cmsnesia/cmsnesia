package id.or.gri.web.config.interceptor;
    ...
    public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
        ...
        return super.writeWith(buffer.doOnNext(dataBuffer -> {
            ...
            try {
                ...
                if (logHeaders) {
                    log.info("Response({} ms): status={}, payload={}", "X-Response-Time:" + (System.currentTimeMillis() - startTime),
                            "X-Response-Status:" + getStatusCode(), bodyRes);
                } else {
                    log.info("Response({} ms): status={}, payload={}", "X-Response-Time:" + (System.currentTimeMillis() - startTime),
                            "X-Response-Status:" + getStatusCode(), bodyRes);
                }
